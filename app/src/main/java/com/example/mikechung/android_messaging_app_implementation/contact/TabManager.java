...
/**
 * Created by MikeChung on 15/6/22.
 */
public class TabManager implements TabHost.OnTabChangeListener {
    ...
    public void onTabChanged(String tabId) {
        ...
        if (mLastTab != newTab) {
            ...
            //
            // Set the background of the tab while tab changed
            //
            for(int i=0; i < mTabHost.getTabWidget().getChildCount();i++){
                mTabHost.getTabWidget().getChildAt(i).setBackgroundColor(Color.GRAY);
            }
            mTabHost.getTabWidget().getChildAt(mTabHost.getCurrentTab()).setBackgroundColor(Color.parseColor("#ffe550"));
